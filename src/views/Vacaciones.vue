<template>
    <div class="contenedor">
        ...
        <div class="asidex">
            ...
            <div class="icono_menu_a" @click="set_modulo('menu_vacaciones')">
        ...
        <div class="seccion_a">
            ...
            <MenuVacaciones v-if="modulo == 'menu_vacaciones'"/>
...
import MenuVacaciones from '../components/Vacaciones/menu.vue'
